...
function AddColorModal({ isOpen, setIsOpen }: IAddColorModal) {
...
function EditColorModal({ isOpen, setIsOpen, card, index }: IAddColorModal & { card: ICard, index?: number }) {
